...
def monta_arquivo():
    armazenado = r'C:\Users\bruno\Downloads\FaceRecognition_v2\src\assets\conhecidos'
    rostos_conhecidos = []
    nomes_dos_rostos = []
    ...
    for pessoa in os.listdir(armazenado):
        ...
        df.to_csv(r'C:\Users\bruno\Downloads\FaceRecognition_v2\src\assets\rostos_conhecidos.csv', index=False)

def get_rostos():
    rostos_conhecidos = []
    nomes_dos_rostos = []
    df = pd.read_csv(r'C:\Users\bruno\Downloads\FaceRecognition_v2\src\assets\rostos_conhecidos.csv')
